...
class VscodeExtensionContributionTests(unittest.TestCase):
    ...
    def test_sidebar_is_simple_first_with_advanced_details_collapsed(self) -> None:
        ...
        self.assertIn('id="boostModeGrid"', source)
        self.assertIn('id="advancedBoostModeGrid"', source)
        self.assertIn('data-boost-mode="${escapeHtml(option.mode)}"', source)
        self.assertIn('type: "setBoostMode"', source)
        self.assertIn("Save Tokens", source)
        self.assertIn("Balanced", source)
        self.assertIn("Best Result", source)
        self.assertIn("Turbo Boost", source)
        self.assertIn("Big Refactor", source)
