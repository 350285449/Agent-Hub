...
from .real_model_validation import export_real_model_validation_status
...
def run_research_analysis(state_dir: str | Path) -> dict[str, Any]:
    ...
    real_model_paths = export_real_model_validation_status(state_dir)
    return {
        ...
        "real_model_validation": real_model_paths["json"],
        "real_model_validation_markdown": real_model_paths["markdown"],
